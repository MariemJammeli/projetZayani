...
<body>
   ...
   <header class="header" id="header">
      <nav class="nav container">
         <a href="index.html" class="nav__logo">Zayani</a>
         ...
         <div class="nav__menu" id="nav-menu">
            <ul class="nav__list">
               ...
               <li class="nav__item">
                  <a href="designers.html" class="nav__link">Designers</a>
               </li>
         ...
         <div class="nav__actions">
            ...
            <!-- Login button -->
            <a href="signin.html"><i class="ri-user-line nav__login" id="login-btn"></i></a>
   ...
   <div class="div1">
        ...
        <input type="file"  class="input_fields" required name="photo_product">
